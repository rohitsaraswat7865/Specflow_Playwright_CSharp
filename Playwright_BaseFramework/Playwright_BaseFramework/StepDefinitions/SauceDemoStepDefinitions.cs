...
namespace Playwright_BaseFramework.StepDefinitions
{
    ...
    public sealed class SauceDemoStepDefinitions
    {
        ...
        [When(@"Enter username as Standard_User in login page")]
        public void WhenEnterUsernameAsStandard_UserInLoginPage()
        {
        ...
        public void WhenSelectFollowingBackpackBoltT_ShirtBikeLightInProductPage()
        {
        ...
        public void WhenRemoveABoltT_ShirtFromCart()
        {
        ...
        public void WhenProvideUserInformationRohitAndSaraswatAnd(int p0)
        {
